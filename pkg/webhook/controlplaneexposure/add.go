...
// AddOptions are options to apply when adding the kubevirt exposure webhook to the manager.
type AddOptions struct {
	// ETCDStorage is the etcd storage configuration.
	ETCDStorage config.ETCDStorage
}

var logger = log.Log.WithName("kubevirt-controlplaneexposure-webhook")
