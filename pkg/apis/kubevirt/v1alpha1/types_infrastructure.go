...
type InfrastructureStatus struct {
	...
	Networks NetworksStatus `json:"networks"`
}

// NetworksStatus contains information about the status of the infrastructure networks.
type NetworksStatus struct {
	// NetworkNames are the names (in the format <name> or <namespace>/<name>) of all networks
	// (both shared and tenant) specified in the network configuration.
